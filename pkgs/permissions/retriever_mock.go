...
func (r *mockRetriever) MockRevoked(t *testing.T, impl func(context.Context, string, string, []string, time.Time) (bool, error)) {
...
func (r *mockRetriever) Revoked(ctx context.Context, namespace string, tokenID string, claims []string, iat time.Time) (bool, error) {

	r.Lock()
	defer r.Unlock()

	if mock := r.currentMocks(r.currentTest); mock != nil && mock.revokedMock != nil {
		return mock.revokedMock(ctx, namespace, tokenID, claims, iat)
	}
