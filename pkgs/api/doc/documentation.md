...
Retrieves the list of oauthapplications.

Parameters:

- `q` (`string`): This is an example.

##### `POST /oauthapplications`

Creates a new oauthapplication.

##### `DELETE /oauthapplications/:id`

Delete a particular oauthapplication object.

##### `GET /oauthapplications/:id`

Get a particular oauthapplication object.

##### `PUT /oauthapplications/:id`

Update a particular oauthapplication object.
...
```json
{
  "clientID": "my-client",
  "clientSecret": "s3cr3t",
  "oauthApplicationID": "67f7b5f3f1f2d1c1b0a99887",
  "oauthApplicationNamespace": "/my/ns",
  "redirectURIs": [
...
Retrieves the list of oauthclients.
...
Delete a particular oauthclient object.

##### `GET /oauthclients/:id`

Get a particular oauthclient object.

##### `PUT /oauthclients/:id`

Update a particular oauthclient object.
...
##### `oauthApplicationNamespace` [`required`]
...
Type: `enum(ClientSecretBasic | ClientSecretPost | None)`
...
##### `expirationTime` [`autogenerated`,`read_only`]

Type: `time`

The expiration time of the delivered token.
...
Type: `enum(A3S | AWS | Azure | GCP | HTTP | LDAP | MTLS | OIDC | RemoteA3S | SAML | OAuth2)`
...
Additional issuing information for the OAuth2 source.
...
Additional issuing information for the SAML source.
...
Retrieves the list of oauth2sources.
...
Creates a new oauthpsource.

##### `DELETE /oauth2sources/:id`

Delete a particular oidcsource object.

##### `GET /oauth2sources/:id`

Get a particular oidcsource object.

##### `PUT /oauth2sources/:id`
...
Retrieves the list of samlsources.
...
- `claim` (`string`): Claim to use to filter down revocations.
- `q` (`string`): This is an example.
...
Type: [`[]oauth2source`](#oauth2source)
