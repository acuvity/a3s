...
type Issue struct {
	...
	ExpirationTime time.Time `json:"expirationTime" msgpack:"expirationTime" bson:"-" mapstructure:"expirationTime,omitempty"`
...
func (o *Issue) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
func (o *Issue) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
var IssueAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Claims": {
		...
		Description: `The list of claims delivered in the token. This can be useful when the caller
needs to have information about the user when token is delivered as a secure
httpOnly cookie.`,
		Exposed:  true,
		Name:     "claims",
...
type SparseIssue struct {
	...
	// The expiration time of the delivered token.
	ExpirationTime *time.Time `json:"expirationTime,omitempty" msgpack:"expirationTime,omitempty" bson:"-" mapstructure:"expirationTime,omitempty"`
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseIssue) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseIssue) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
